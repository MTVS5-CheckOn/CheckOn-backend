 ...
 */
@RestController
@RequestMapping("/api/v1/member/students/me/invitations")
public class StudentInvitationController {

	private static final String VERIFICATION_ROUTE_KEY =
		"POST /member/students/me/invitations/verification";
	...
	public StudentInvitationController(
	...
	public MemberResponse<InviteVerificationView> verifyStudentInvitation(
	...
	@PostMapping
	public ResponseEntity<String> claimStudentInvitation(
		@CurrentMember MemberSubject subject,
		@RequestHeader(value = IdempotencyKeys.HEADER, required = false) String idempotencyKey,
		@RequestBody String rawBody,
		HttpServletRequest request
	) {
		rateLimiter.check(InvitationClaimService.STUDENT_ROUTE_KEY, subject.accountId(),
